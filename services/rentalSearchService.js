...
if (lead.projectStatus) {
    ...
    if (
        Array.isArray(lead.projectStatus) &&
        lead.projectStatus.length > 0
    ) {
    ...
    } else if (!Array.isArray(lead.projectStatus)) {
...
Security Deposit: ₹${p.securityDeposit || "N/A"}
Maintenance: ₹${p.maintenanceCharges || "Included"}
Lease Duration: ${p.leaseDurationMonths || "Flexible"} months
